...
class Config(object):
    ...
    TECH_VJ_URL = environ.get('TECH_VJ_URL', 'urllinkshort.in') # your shortlink url domain or url without https://
    TECH_VJ_API = environ.get('TECH_VJ_API', 'a7c8ec9f5071ca0bfd20f287cf6ab31e5232947e') # your url shortner api
    TECH_VJ_TUTORIAL = os.environ.get("TECH_VJ_TUTORIAL", "https://t.me/redirect_to_lion_stage/16")
