...
ᴛʜɪs ʙᴏᴛ ɪs ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href="https://t.me/movie_time_botonly">𝐓𝐑𝐔𝐌𝐁𝐎𝐓𝐒</a></b>
"""
...
🔻 ʜᴏᴡ ᴛᴏ ᴜᴘʟᴏᴀᴅ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋs 🔻
    👨‍💻 How To Upload YouTube Link

👉 Example:- This is share link of YouTube :- https://youtu.be/example?=example1

Replace above link into this
First remove ?=example1 from link
Then youtu.be into youtube.com and add watch?v=

Ex :- https://youtube.com/watch?v=example

Else:
    You can also send direct link :- 
    https://youtu.be/example?=example1
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [ [
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/TRUMBOTCHAT'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/movie_time_botonly')
        ], [
            InlineKeyboardButton('❓ ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('🦊 ᴀʙᴏᴜᴛ', callback_data='about')
        ], [
            InlineKeyboardButton('🖥️ 🇧​​🇴​​🇹​​🇸​ ​🇱​​🇮​​🇸​​🇹​ 🖥️', url='https://te.legra.ph/TRUMBOTS-BOTS-LIST-06-01'),
